...
![](/assets/img/posts/migrated/2019/04/6.png)  

2. Una vez abierto el programa, escribimos el código:  
![](/assets/img/posts/migrated/2019/04/7.png)  
```
print('Hola mundo')
```
3. Al presionar la tecla "Enter" mostrará el mensaje:  
![](/assets/img/posts/migrated/2019/04/8.png)  
