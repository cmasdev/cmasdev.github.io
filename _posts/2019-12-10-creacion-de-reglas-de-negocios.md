...
![](/assets/img/posts/migrated/2019/12/1-5.png)  

![](/assets/img/posts/migrated/2019/12/2-5.png)  

![](/assets/img/posts/migrated/2019/12/3-5.png)  

A continuación, agregamos los detalles de la regla de negocio:  
![](/assets/img/posts/migrated/2019/12/4-4.png)  

Colocamos las propiedades de la Entidad que deseamos controlar y agregamos las condiciones:  
![](/assets/img/posts/migrated/2019/12/5-2.png)  
...
![](/assets/img/posts/migrated/2019/12/6-2.png)  

Agregamos la acción para el **sí**:  
![](/assets/img/posts/migrated/2019/12/7-1.png)  

Luego, agregamos la acción pàra el **no**:  
![](/assets/img/posts/migrated/2019/12/8-1.png)  

Una vez terminado, hacemos clic en **Validar** y luego en **Guardar**:  
![](/assets/img/posts/migrated/2019/12/9-1.png)  

Si todo es correcto, procedemos a **Activar** la regla de negocio:  
![](/assets/img/posts/migrated/2019/12/10.png)  

Probamos el no cumplimiento de la condición:  
![](/assets/img/posts/migrated/2019/12/11.png)  

Y por último, probamos el cumplimiento de la condición:  
![](/assets/img/posts/migrated/2019/12/12.png)  
