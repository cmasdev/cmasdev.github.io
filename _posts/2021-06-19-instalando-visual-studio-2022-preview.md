...
![](/assets/img/posts/visualstudio/visual-studio-2022-preview-1_1.png)    

1. Seleccionar la versión de Visual Studio que necesitamos (siempre elijo Professional):  
![](/assets/img/posts/visualstudio/visual-studio-2022-preview-1_2.png)  

2. Veremos la ventana principal del instalador y hacemos clic en "Continuar":  
![](/assets/img/posts/visualstudio/visual-studio-2022-preview-1_3.png)  
...
![](/assets/img/posts/visualstudio/visual-studio-2022-preview-1_4.png)  
...
![](/assets/img/posts/visualstudio/visual-studio-2022-preview-1_5.png)  

5. Listo. Estamos listos para la primera experiencia Visual Studio 2022 Preview 1:  
![](/assets/img/posts/visualstudio/visual-studio-2022-preview-1_6.png)  

# Primera vez con Visual Studio 2022 Preview 1  
1. Una vez instalado procedemos a iniciar el nuevo programa instalado:  
![](/assets/img/posts/visualstudio/visual-studio-2022-preview-1_7.png)  

2. Pantalla principal del Visual Studio:  
![](/assets/img/posts/visualstudio/visual-studio-2022-preview-1_8.png)  

3. Creación de un nuevo proyecto:  
![](/assets/img/posts/visualstudio/visual-studio-2022-preview-1_9.png)  

4. Entorno de desarrollo UWP (Universal Windows Platform):  
![](/assets/img/posts/visualstudio/visual-studio-2022-preview-1_10.png)  
