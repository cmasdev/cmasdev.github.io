...
![](/assets/img/posts/migrated/2019/05/1-1.png)  

Colocamos una etiqueta(Label):  
![](/assets/img/posts/migrated/2019/05/2-1.png)  

Insertamos un cuadro de texto (TextInput):  
![](/assets/img/posts/migrated/2019/05/3-1.png)  

Agregamos un botón (Button) con una fórmula para capturar el texto ingresado:  
![](/assets/img/posts/migrated/2019/05/4-1.png)  

Ejecutamos y vemos los controles:  
![](/assets/img/posts/migrated/2019/05/5-1.png)  

Al hacer clic en el botón "Saludar" se ve el mensaje:  
![](/assets/img/posts/migrated/2019/05/6-1.png)  
