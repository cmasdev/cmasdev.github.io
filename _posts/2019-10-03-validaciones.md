...
![](/assets/img/posts/migrated/2019/10/1-1.png)  
...
![](/assets/img/posts/migrated/2019/10/2-1.png)  

Tenemos en cuenta los siguientes controles, que ya existen en nuestra plantilla:  
![](/assets/img/posts/migrated/2019/10/3-1.png)  

En el control **ErrorMessage5**, colocamos el texto que deseamos mostrar cuando se produzca el error:  
![](/assets/img/posts/migrated/2019/10/3_1.png)  

Seguidamente aplicamos la fórmula necesaria en la propiedad **Visible** del control **ErrorMessage5**:  ![](/assets/img/posts/migrated/2019/10/4.png)  
```
If(IsNumeric(DataCardValue14.Text),true,false)
```
Ejecutamos la aplicación y verificamos los resultados (primero el erróneo):  
![](/assets/img/posts/migrated/2019/10/5.png)  

![](/assets/img/posts/migrated/2019/10/6.png)  
